...
class CodeField extends Fields {
    ...
    public function render() {
        // if wtdqs-codemirror-js not enqueyed
        if(!wp_script_is('wtdqs-codemirror-js', 'enqueued')){
            wp_enqueue_script('wtdqs-codemirror-js');
        }
        ...
        >
            <div class="wtdqs-single-fields-inner wtdqs-single-fields-<?php echo esc_attr($name); ?>">
                ...
                <textarea name="<?php echo esc_attr($name); ?>" id="<?php echo esc_attr($name); ?>" cols="30" rows="10"></textarea>
                <?php 
